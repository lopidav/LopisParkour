...
COPY_FILES = ["manifest.json", "icon.png", "README.md"] # individual files to copy, such as manifest.json, localization.tsv, etc. (the mod dll is copied automatically)
MODS_ROOT = Path("D:/roadman/r2mmData/ROUNDS/profiles/Lopis Parkour/BepInEx/plugins") # windows only, can be hardcoded with the below line instead
...
p = subprocess.Popen("dotnet build Mod.csproj", stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
